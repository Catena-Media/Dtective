package com.dtective.framework.quality.framework.http;

import com.dtective.framework.configuration.ParameterMap;
import com.dtective.framework.placeholders.BDDPlaceholders;
import com.dtective.framework.test.TestDataCore;
import com.dtective.framework.user.QAUserProfile;
import com.dtective.framework.web.HttpManager;
import com.dtective.framework.web.HttpResponseWrapper;
...
import static com.dtective.framework.test.TestDataCore.*;
...
public class HttpStepsCore {
    ...
    public static void iAddHTTPHeaderValue(String key, String value) {
        ...
        if (getDataStore("headers") == null) {
            addToDataStore("headers", new HashMap<String, Object>());
        }

        ((Map<String, Object>) getDataStore("headers")).put(key, value);
    }
    ...
    public static JsonObject getResponseBodyAsJson() {
        HttpResponseWrapper response = (HttpResponseWrapper) getDataStore("response");
    ...
    public void iSetFormData(String key, String value) {
        ...
        if (getDataStore("form") == null) {
            addToDataStore("form", new HashMap<String, Object>());
        }

        ((Map<String, Object>) getDataStore("form")).put(key, value);
    ...
    public void iAddHTTPFormFile(String path, String key) {
        ...
        ((Map<String, Object>) getDataStore("form")).put(key, file);
    }
    ...
    public void iStoreUrlRedirectionsInParam(String localParamName) {
        HttpClientContext context = (HttpClientContext) getDataStore("context");

        Assert.assertNotNull("Response cannot be null", context);
        List<URI> locList = context.getRedirectLocations();

        addToDataStore(localParamName, locList);
    }
    ...
    public void responseURLInParamIs(String param, String expectedURL) {
        List<URI> urls = (List<URI>) getDataStore(param);
    ...
    public void iChangeValueOfKeyInJSONFromStoredParamToNullAndSaveItInStoredParam(String key, String bodyParam,
                                                                                   String newParam) {
        JSONObject jsonBody = new JSONObject(getDataStore(bodyParam).toString());
    ...
    public void iChangeValueOfKeyInJSONFromStoredParamWithValueFromStoredParamAndSaveItInStoredParam(String key,
        ...
        for (int i = 0; i <= keys.length - 1; i++) {
            jsonBody.put(keys[i], getDataStore(valueParam));
        }
    ...
    public void iAddToTheJSONRequestBodyAKeyWithValueFromStoredParam(String key, String param) {
        JSONObject json = new JSONObject(getDataStore("requestBody").toString());
        String value = getDataStore(param).toString();
        json.put(key, value);
        addToDataStore("requestBody", json);
    }
    ...
    public void iSaveContentsOfFileInStoredParam(String file, String param) {
        ...
        JSONObject jsonBody = new JSONObject(returnStringFromFileOrDataStore(file));
        addToDataStore(param, jsonBody);
    }
    ...
    public void iGenerateANewObjectIDAndSaveItInStoredParam(String param) {
        addToDataStore(param, newObjectId());
    }
    ...
    public void storedParamContainsKeyWithValue(String param, String key, String value) {
        JsonObject parsedBody = new JsonParser().parse(getDataStore(param).toString()).getAsJsonObject();
    ...
    private void assertKeyAndValueInJson(String key, String value, JsonObject jsonObject) {
        ...
        try {
            ...
            Assert.assertNotNull("Value of searched key was null or not a valid type", actualValue);
    ...
    public void iSetBasicAuth(String username, String password) {
        ...
        ((Map<String, Object>) getDataStore("headers")).put("Authorization", "Basic " + encodedAuth);
