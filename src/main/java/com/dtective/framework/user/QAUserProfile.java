package com.dtective.framework.user;
...
import com.dtective.framework.utils.ClipboardHelper;
import com.dtective.framework.utils.MemoryHelper;
import com.dtective.framework.utils.WebElementHelper;
...
import static com.dtective.framework.test.TestStepsCore.getScenario;
...
//        logger.debug(String.format("%s is taking screenshot : %s", name, name));
    ...
    public void dropdownSelect(By by, String value) {
        ...
        org.openqa.selenium.support.ui.Select select = new Select(WebElementHelper.findElement(by));
