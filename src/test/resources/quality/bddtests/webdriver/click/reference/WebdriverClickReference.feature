...
Feature: Web-Driver Click
  ...
  Scenario: Double Click Test (with data setup using attribute-value)
    ...
    And I open website "https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_ondblclick"
  ...
  Scenario: Context Click Test (with data setup using attribute-value)
    ...
    Given I add to data-store "contextclick-button" containing key "id" and value "carbonads"
    And I open website "http://labs.qnimate.com/contextmenu/contextmenu1.html"
  ...
  Scenario: Context Click Test (with data setup using xpath)
    ...
    Given I add the following data-store "contextclick-button-xpath" "//*[@id='carbonads']"
    And  I open website "http://labs.qnimate.com/contextmenu/contextmenu1.html"
