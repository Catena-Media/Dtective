...
#  Background: This test is designed to demonstrate how BDD steps can be used with HTML Attribute-Value
  ...
  Scenario: Double Click Test - Attribute-Value - Equals
    ...
    Given I open website "https://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_ondblclick"
    And I switch context to iFrame "iframeResult"
  ...
  Scenario: Context Click Test - Equals
    ...
    Given I open website "http://labs.qnimate.com/contextmenu/contextmenu1.html"
    When I context click element with Attribute "id" Value "carbonads"
  ...
  Scenario: Context Click Test - Contains
    ...
    Given I open website "http://labs.qnimate.com/contextmenu/contextmenu1.html"
    When I context click element with Attribute "id" and Value that contains "carbonads"
    Then text displays "Share On Facebook"
  ...
  Scenario: Context Click Test - Contains-Multiple
    ...
    Given I open website "http://labs.qnimate.com/contextmenu/contextmenu1.html"
    When I context click element with Attribute "id" and Value that contains "carbon" and ads""
    Then text displays "Share On Facebook"
